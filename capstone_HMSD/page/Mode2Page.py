...
class Mode2Page(object):
    def __init__(self,name,arduino):
        ...
        self.root.title('Mode 2 - Training Mode')
    ...
    def createMainPage(self):
        ...
        text = tk.Label(self.root,text="You are in Mode 2 - Training Mode",font=14,pady=10)
        text.pack()
    ...
    def run(self,speed,torque):
        ...
        try:
            ...
            val = (2,speed.get(),torque.get(),self.name)
            print(sql % val)
